...
#ifndef JUCE_WwiseSourceParams_H
#define JUCE_WwiseSourceParams_H
...
struct JUCE_WwiseRTPCParams
{
    AkReal32 fDuration;
};

struct JUCE_WwiseNonRTPCParams
{
};

struct JUCE_WwiseSourceParams
    : public AK::IAkPluginParam
{
    JUCE_WwiseSourceParams();
    JUCE_WwiseSourceParams(const JUCE_WwiseSourceParams& in_rParams);
    ...
    JUCE_WwiseRTPCParams RTPC;
    JUCE_WwiseNonRTPCParams NonRTPC;
};

#endif // JUCE_WwiseSourceParams_H
